...
Check for and install CLI updates from GitHub Releases. The command compares your installed version against the latest release and optionally downloads and installs the newer version using the project's install script.
