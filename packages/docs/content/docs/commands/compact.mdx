...
Archive completed tasks and the progress log into a dated historical record, then clean up the originals. This keeps the working `.ody/tasks/` directory focused on active work.
...
<Files>
  <Folder name=".ody" defaultOpen>
    <Folder name="history" defaultOpen>
      <Folder name="2026-01-01" defaultOpen>
        <File name="progress.md -- Archived progress log" />
        <File name="tasks.md -- Archived completed tasks" />
      </Folder>
    </Folder>
  </Folder>
</Files>
...
- [`ody plan`](/docs/commands/plan) -- Create task plans that compact eventually archives
