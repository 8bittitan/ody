...
Import an issue from Jira or GitHub and generate a structured `.code-task.md` file in `.ody/tasks/`. The command fetches issue details, builds an import prompt, and runs your configured backend agent.
