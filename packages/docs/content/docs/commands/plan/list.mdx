...
List all pending task files in the `.ody/tasks/` directory. Shows the title and filename of each task that has `status: pending` in its YAML frontmatter.
...
- [`ody task edit`](/docs/commands/plan/edit) -- Edit an existing task plan
