...
Run the agent loop to execute pending tasks. The loop picks up tasks from `.ody/tasks/`, builds a prompt, sends it to the configured backend, and monitors for a completion marker.
